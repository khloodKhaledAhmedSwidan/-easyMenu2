...
{{--                @endif--}}
             <input type="password" id="password" name="password" placeholder=" ادخل الرقم السري" required class="form-control"/>
...
{{--                @endif--}}
            <input type="password" placeholder="تاكيد الرقم السري" id="password_confirmation" required class="form-control" name="password_confirmation"/>
