...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>اضافة مطعم</span>
        </li>
    </ul>
</div>

<h1 class="page-title"> المطاعم
    <small>اضافة مطعم</small>
</h1>
@endsection
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name_ar" placeholder="اسم المطعم"
                                        ...
                                        <div class="form-group">
                                            <label class="control-label"> اسم المطعم بالانجليزية</label>
                                            <input type="text" name="name" placeholder=" اسم المطعم بالانجليزية"
