...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>عرض الطلبات الغير مؤكده</span>
        </li>
    </ul>
</div>

<h1 class="page-title">عرض الطلبات الغير مؤكده
    <small>عرض جميع الطلبات الغير مؤكده</small>
</h1>
@endsection
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase"> الطلبات الغير مؤكده</span>
                </div>
